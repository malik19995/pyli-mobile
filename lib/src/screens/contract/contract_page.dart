...
import 'package:customerapp/src/models/site_model.dart';
    ...
    return Container(
      ...
      child: Obx(() => Column(
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<SiteModel>(
                    onChanged: (site) => siteController.selectedSite(site),
                    value: siteController.selectedSite.value,
                    ...
                    items: siteController.allSites
                        .map((site) => DropdownMenuItem(
                              value: site,
                              child: Text("${site.title} - ${site.subtitle}"),
                            ))
                        .toList(),
                  ),
                ),
              ...
              _ContractInfo(
                  // pendingCancel:
                  //     controller.selectedSite.value == 'Site 2 - 8765 Blue RD'
                  )
            ],
          )),
    );
          ...
          Container(
            ...
            child: ListView(
              children: [
                ...
                SizedBox(height: 20),
                InfoWidget(title: 'Frequency', subtitle: 'Yearly'),
                InfoWidget(title: 'Auto-Renewal', subtitle: 'Yes'),
                InfoWidget(title: 'Start Date', subtitle: '01/02/2021'),
                InfoWidget(title: 'Next Billing Date', subtitle: '01/02/2022'),
                InfoWidget(title: 'Adjustments', subtitle: '\$45'),
                InfoWidget(
                ...
                Wrap(
                  children: [1, 2, 3]
                      .map((addon) => _AddOns(title: addon.toString()))
                      .toList(),
                ),
                SizedBox(height: 32),
                CButton(
