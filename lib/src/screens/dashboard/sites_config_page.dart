                                ...
                                itemBuilder: (_, index) => _SitesWidget(
                                    onTap: () {
                                      controller.selectedSite(
                                          controller.allSites[index]);
                                      setState(() {});
                                    },
                                    item: controller.allSites[index],
                                    active: controller.allSites[index] ==
...
class _SitesWidget extends StatelessWidget {
  ...
  const _SitesWidget(
      {Key? key, required this.item, required this.active, required this.onTap})
      : super(key: key);
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: !active
                      ? Border.all(color: CColors.primary, width: 4)
                      : null),
